...
2. Run the automated tests: `odoobot 19 test.conf tests --no-coverage`. Note! ALWAYS report the amount of tests after the command finishes (odoo tells it in the logs)
